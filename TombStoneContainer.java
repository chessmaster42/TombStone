...
public class TombStoneContainer extends Container {
	protected TombStoneTileEntity tileEntity;
	
	public TombStoneContainer (InventoryPlayer inventoryPlayer, TombStoneTileEntity te){
		tileEntity = te;
